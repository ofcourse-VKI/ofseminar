...
Info << "Gravity aceleration [m/s2] = " << gravityAcc << endl;
//End of acceleration dictionary reading
	...
	g=gunits*amplitudeAcc[0]*Foam::pow(omegaAcc[0],2)*Foam::cos(omegaAcc[0]*runTime.value())*vector(1,0,0)+    gunits*gravityAcc[0]*vector(1,0,0)+
		  gunits*amplitudeAcc[1]*Foam::pow(omegaAcc[1],2)*Foam::cos(omegaAcc[1]*runTime.value())*vector(0,1,0)+ gunits*gravityAcc[1]*vector(0,1,0)+
		  gunits*amplitudeAcc[2]*Foam::pow(omegaAcc[2],2)*Foam::cos(omegaAcc[2]*runTime.value())*vector(0,0,1)+ gunits*gravityAcc[2]*vector(0,0,1);
